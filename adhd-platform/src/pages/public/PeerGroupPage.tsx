...
const TODO_LINKS = {
  LINK_1: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_2: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_3: 'https://mountain-sail-ee8.notion.site/1f6ffa2c66cc471899275a62db2e8d05?pvs=105',
  LINK_4: 'https://mountain-sail-ee8.notion.site/1f6ffa2c66cc471899275a62db2e8d05?pvs=105',
  LINK_5: 'https://mountain-sail-ee8.notion.site/1f6ffa2c66cc471899275a62db2e8d05?pvs=105',
  LINK_6: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_7: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_8: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_9: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_10: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_11: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_12: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_13: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_14: 'https://mountain-sail-ee8.notion.site/1f6ffa2c66cc471899275a62db2e8d05?pvs=105',
  LINK_15: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_16: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_17: 'https://mountain-sail-ee8.notion.site/97c41d5530d145b18d7d8739f572d64d?pvs=105',
  LINK_18: 'https://forms.gle/Up6LFmBe7qCiSe6Z6',
  LINK_19: 'https://mountain-sail-ee8.notion.site/2-2098b8084dad80928e66d53a6ba373e7?source=copy_link',
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] text-[#5D4037] font-body">
      <svg className="hidden" height="0" width="0"><filter id="hand-drawn"><feTurbulence baseFrequency="0.01" numOctaves="3" result="noise" type="fractalNoise"></feTurbulence><feDisplacementMap in="SourceGraphic" in2="noise" scale="2" xChannelSelector="R" yChannelSelector="G"></feDisplacementMap></filter></svg><header className="hero-section pt-10 px-4 mb-16" id="about"><div className="absolute top-20 right-[-50px] w-96 h-96 opacity-40 animate-blob pointer-events-none"><svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path d="M44.7,-76.4C58.9,-69.2,71.8,-59,79.6,-45.3C87.4,-31.7,90.2,-14.8,88.2,0.8C86.2,16.5,79.4,30.9,70.1,43.1C60.8,55.3,49,65.3,35.5,72.5C22,79.7,6.7,84.1,-8.9,83.9C-24.5,83.7,-40.4,78.9,-53.2,69.7C-66,60.5,-75.7,46.9,-81.3,31.8C-86.9,16.7,-88.4,0,-85.2,-15.2C-82,-30.4,-74.1,-44.1,-62.8,-52.9C-51.5,-61.7,-36.8,-65.7,-23.4,-73.1C-10,-80.5,2.1,-91.3,16.1,-90.8C30.1,-90.3,46,-83.5,44.7,-76.4Z" fill="#FFD6BA" transform="translate(100 100)"></path></svg></div><div className="max-w-4xl mx-auto flex flex-col items-center relative z-10"><div className="w-full space-y-8"><div className="text-center md:text-left"><div className="inline-block bg-white border-2 border-[#5D4037] px-4 py-1 rounded-full text-sm font-bold shadow-comic transform -rotate-1 text-accent-teal mb-4">
                        ✨ 專屬單項服務介紹
                    </div><h1 className="font-heading text-4xl md:text-5xl font-black leading-tight text-[#5D4037]">【大A彥宇】115年度成人ADHD線上互助聚會</h1></div>
...
<p className="leading-relaxed text-lg font-medium text-justify">
                        ...
                        新的一年（115年）到來，很開心又能與大家繼續前行。今年邀請了幾位專業的講師好朋友，準備了一系列貼近我們生活的主題。<br/></p><div className="text-center mt-6 py-4"><span className="inline-block bg-[#FFF9C4] px-6 py-3 rounded-full font-black text-xl border-2 border-[#5D4037] shadow-sm transform -rotate-1 text-[#D84315]">✨ 無需準備、不必讀書、帶著好奇心就能參加！ ✨</span></div>
</div>
</div>
</div>
</div>
</header><div className="max-w-4xl mx-auto px-4 mb-12"><Link to="/peer-group/register" className="btn-warm w-full py-4 bg-[#FFEC8B] text-[#5D4037] text-xl font-black flex items-center justify-center gap-2 border-2 border-[#5D4037] shadow-comic">🖊️ 站內報名（額滿即時顯示）</Link></div><div className="max-w-6xl mx-auto px-4 space-y-20"><section id="groups">
<div className="bg-white border-2 border-[#5D4037] rounded-3xl p-6 md:p-10 mb-10 relative shadow-[8px_8px_0_rgba(93,64,55,0.15)] flex flex-col gap-8"><div className="space-y-4 text-[#5D4037]"></div><div className="bg-[#E0F7FA] border-l-8 border-accent-teal p-6 rounded-r-2xl"><h4 className="font-bold text-[#006064] text-xl mb-3 flex items-center gap-2"><Video className="w-6 h-6"></Video> 參加須知
                    </h4><ul className="text-[#006064] space-y-2 font-bold list-disc list-inside text-lg"><li>一律採用 <strong className="text-[#004D40] bg-[#B2EBF2] px-1 rounded">GOOGLE MEET 視訊</strong></li><li>可<strong className="text-[#004D40] bg-[#B2EBF2] px-1 rounded">不開鏡頭</strong>，害羞的朋友也不用擔心喔！</li><li>表單是預先統計人數用的！沒報名也可以當天直接參加！</li></ul></div><div className="mt-2 w-full"><a className="btn-warm py-5 px-6 bg-accent-orange text-[#5D4037] w-full text-2xl md:text-3xl shadow-comic animate-pulse-slow flex flex-col items-center justify-center border-4 border-[#5D4037]" href={TODO_LINKS.LINK_1} target="_blank"><span>📝 立即填寫報名表</span><span className="text-base font-bold mt-2 opacity-80 bg-white/40 px-3 py-1 rounded-full border border-[#5D4037]/20">預先報名讓我們更好準備喔！</span></a></div></div>
<div className="border-t-4 border-dashed border-[#5D4037]/20 pt-8"><div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6"><div className="space-y-1"><h3 className="text-2xl font-bold text-[#5D4037] flex items-center gap-2"><span className="bg-accent-teal text-white px-2 py-1 rounded text-lg border border-[#5D4037]">辦理</span>
                            ADHD 成人同儕線上團體-場次說明
                                ...
                                </a><a className="btn-warm py-2 px-4 bg-[#FFCC80] text-[#5D4037] hover:bg-[#FFB74D] text-sm" href={TODO_LINKS.LINK_2} target="_blank">報名表單</a></div></div></div></div>
...
<div className="bg-white/70 p-6 md:p-8 rounded-2xl border-2 border-[#5D4037]/10 backdrop-blur-sm shadow-sm"><div className="font-body text-[#5D4037] leading-relaxed font-medium text-justify text-lg space-y-4"><p>我從小學三年級就診斷ADHD，一路跌跌撞撞成長到大。</p><p>現在是社會工作者-身心障礙者服務中心 社工督導，同時也是受到社團法人台灣赤子心過動症協會總會鼓勵、栽培的倡議工作者。</p><p className="text-xl font-bold text-accent-teal py-1">我希望可以幫助更多像我一樣的人！</p><p>除了本職工作外，我利用下班時間及假日，正在創建各項服務。我相信 <span className="marker-highlight font-bold">從無到有本身就有價值</span>。希望能讓更多的 ADHD 家長、孩童、大A夥伴因此受益。</p><div className="bg-[#FFF9C4]/60 p-4 rounded-xl border border-[#5D4037]/10 mt-4 text-[#5D4037]">
                    ...
                    </h3><div className="grid grid-cols-1 md:grid-cols-2 gap-4"><a className="bg-white p-4 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-teal hover:shadow-md transition-all group flex flex-col" href={TODO_LINKS.LINK_19} target="_blank"><div className="flex justify-between items-start mb-2"><span className="bg-[#B2EBF2] text-[#006064] text-xs font-bold px-2 py-1 rounded">新聞報導</span><ArrowUpRight className="w-4 h-4 text-[#5D4037] group-hover:text-accent-teal"></ArrowUpRight></div><div className="font-bold text-[#5D4037] group-hover:text-accent-teal">ADHD長大成助人者</div></a><div className="space-y-3"><a className="flex items-center justify-between bg-white p-3 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-pink hover:shadow-md transition-all group" href={TODO_LINKS.LINK_20} target="_blank"><span className="text-sm font-bold text-[#5D4037]">友善 ADHD 父母的環境</span><PlayCircle className="w-5 h-5 text-[#5D4037] group-hover:text-accent-pink"></PlayCircle></a><a className="flex items-center justify-between bg-white p-3 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-pink hover:shadow-md transition-all group" href={TODO_LINKS.LINK_21} target="_blank"><span className="text-sm font-bold text-[#5D4037]">跟人相處這麼難嗎？</span><PlayCircle className="w-5 h-5 text-[#5D4037] group-hover:text-accent-pink"></PlayCircle></a></div></div></div>
</div>
</div>
</section>
