  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] text-[#5D4037] font-body">
      ...
      <nav className="w-full py-2.5 px-6 bg-[#FFEC8B]/60 border-b border-[#5D4037]/20"><div className="max-w-6xl mx-auto flex flex-wrap items-center gap-x-6 gap-y-1 font-bold text-[#5D4037] text-sm"><span className="text-xs text-[#5D4037]/70">本頁快速前往：</span><a className="hover:text-accent-orange transition-colors" href="#about">關於彥宇</a><a className="hover:text-accent-teal transition-colors" href="#actions">實踐項目</a><a className="hover:text-accent-pink transition-colors" href="#groups">115年計畫</a><a className="hover:text-line-green transition-colors" href="#line-contact">官方LINE</a></div></nav><header className="hero-section pt-10 px-4 mb-16" id="about"><div className="absolute top-20 right-[-50px] w-96 h-96 opacity-40 animate-blob pointer-events-none"><svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path d="M44.7,-76.4C58.9,-69.2,71.8,-59,79.6,-45.3C87.4,-31.7,90.2,-14.8,88.2,0.8C86.2,16.5,79.4,30.9,70.1,43.1C60.8,55.3,49,65.3,35.5,72.5C22,79.7,6.7,84.1,-8.9,83.9C-24.5,83.7,-40.4,78.9,-53.2,69.7C-66,60.5,-75.7,46.9,-81.3,31.8C-86.9,16.7,-88.4,0,-85.2,-15.2C-82,-30.4,-74.1,-44.1,-62.8,-52.9C-51.5,-61.7,-36.8,-65.7,-23.4,-73.1C-10,-80.5,2.1,-91.3,16.1,-90.8C30.1,-90.3,46,-83.5,44.7,-76.4Z" fill="#FFD6BA" transform="translate(100 100)"></path></svg></div><div className="max-w-4xl mx-auto flex flex-col items-center relative z-10"><div className="w-full space-y-8"><div className="text-center md:text-left"><div className="inline-block bg-white border-2 border-[#5D4037] px-4 py-1 rounded-full text-sm font-bold shadow-comic transform -rotate-1 text-accent-teal mb-4">
                    ...
                    </h3><div className="grid grid-cols-1 md:grid-cols-2 gap-4"><a className="bg-white p-4 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-teal hover:shadow-md transition-all group flex flex-col" href={TODO_LINKS.LINK_1} target="_blank"><div className="flex justify-between items-start mb-2"><span className="bg-[#B2EBF2] text-[#006064] text-xs font-bold px-2 py-1 rounded">新聞報導</span><ArrowUpRight className="w-4 h-4 text-[#5D4037] group-hover:text-accent-teal"></ArrowUpRight></div><div className="font-bold text-[#5D4037] group-hover:text-accent-teal">ADHD長大成助人者</div></a><div className="space-y-3"><a className="flex items-center justify-between bg-white p-3 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-pink hover:shadow-md transition-all group" href={TODO_LINKS.LINK_2} target="_blank"><span className="text-sm font-bold text-[#5D4037]">友善 ADHD 父母的環境</span><PlayCircle className="w-5 h-5 text-[#5D4037] group-hover:text-accent-pink"></PlayCircle></a><a className="flex items-center justify-between bg-white p-3 rounded-xl border-2 border-[#5D4037]/20 hover:border-accent-pink hover:shadow-md transition-all group" href={TODO_LINKS.LINK_3} target="_blank"><span className="text-sm font-bold text-[#5D4037]">跟人相處這麼難嗎？</span><PlayCircle className="w-5 h-5 text-[#5D4037] group-hover:text-accent-pink"></PlayCircle></a></div></div></div></div></div></header><div className="max-w-6xl mx-auto px-4 space-y-20"><section id="actions"><div className="flex items-center gap-3 mb-8 justify-center md:justify-start"><div className="w-12 h-12 bg-accent-teal rounded-full border-2 border-[#5D4037] flex items-center justify-center text-[#5D4037] shadow-comic"><Flag className="w-6 h-6"></Flag></div><h2 className="font-heading text-3xl font-black text-[#5D4037]">我在114年開始實踐至今</h2></div><div className="grid grid-cols-1 md:grid-cols-2 gap-8"><div className="warm-card p-8 flex flex-col gap-6 bg-white hover:bg-[#F0FDF4] transition-colors"><div className="flex items-center gap-3 border-b-2 border-[#5D4037]/10 pb-4"><Users className="w-8 h-8 text-accent-teal"></Users><h3 className="text-2xl font-bold text-[#5D4037]">個人行動服務</h3></div><div className="space-y-4 flex-grow"><div className="bg-accent-teal/10 p-4 rounded-xl border border-accent-teal/20 relative"><div className="absolute -left-2 top-4 w-4 h-4 bg-accent-teal rounded-full border-2 border-[#5D4037]"></div><strong className="block text-[#5D4037] text-lg mb-1 pl-4">辦理 ADHD 成人同儕線上團體</strong><span className="text-sm text-gray-600 pl-4 block">定期聚會，建立支持網絡。</span></div><div className="bg-accent-teal/10 p-4 rounded-xl border border-accent-teal/20 relative"><div className="absolute -left-2 top-4 w-4 h-4 bg-accent-teal rounded-full border-2 border-[#5D4037]"></div><strong className="block text-[#5D4037] text-lg mb-1 pl-4">免費家長諮詢服務</strong><span className="text-sm text-gray-600 pl-4 block">一對一線上諮詢，提供專業建議。</span></div></div></div><div className="warm-card p-0 flex flex-col bg-white overflow-hidden" id="database"><div className="bg-gradient-to-r from-[#FFDFD3] to-white p-8 border-b-2 border-[#5D4037]/10 flex-grow"><div className="flex items-center gap-3 mb-4"><Database className="w-8 h-8 text-[#FF9E80]"></Database><h3 className="text-2xl font-bold text-[#5D4037]">ADHD 就醫家長推薦資料庫</h3></div><div className="inline-block bg-[#FF9E80] text-white text-xs font-bold px-3 py-1 rounded-full mb-4 border border-[#5D4037]">
                            114年版．家長共同建構
                        </div><p className="text-[#5D4037] leading-relaxed mb-6 font-medium text-lg">
                            承蒙 <span className="text-[#FF9E80]">台灣ADHD交流園地</span> 與 <span className="text-[#FF9E80]">赤子心社群</span> 信任。
                            延續舊有資料庫，這是一份由家長們親身經驗匯聚而成的珍貴地圖。
                        </p></div><div className="p-6 bg-[#FFF3E0]"><a className="btn-warm w-full py-4 bg-[#FF9E80] text-white hover:scale-[1.02] shadow-comic border-[#5D4037]" href={TODO_LINKS.LINK_4} target="_blank">
                            前往資料庫查詢 <ArrowRight className="w-5 h-5 ml-2"></ArrowRight></a></div></div></div></section><section id="groups"><div className="text-center mb-12"><span className="inline-block bg-[#FFEC8B] border-2 border-[#5D4037] px-8 py-4 rounded-full font-black text-[#5D4037] text-4xl md:text-5xl shadow-comic transform -rotate-1 mb-4">
                    🚀 現在啟動 115 年計畫！
                </span></div><div className="bg-white border-2 border-[#5D4037] rounded-3xl p-6 md:p-10 mb-10 relative shadow-[8px_8px_0_rgba(93,64,55,0.15)] flex flex-col gap-8"><div className="space-y-4 text-[#5D4037]"><h3 className="text-2xl font-black mb-4">【大A彥宇】115年度成人ADHD線上互助聚會</h3><p className="leading-relaxed text-lg font-medium text-justify">
                        各位大A夥伴大家好，我是彥宇！👋<br/>
                        ...
                        新的一年（115年）到來，很開心又能與大家繼續前行。今年邀請了幾位專業的講師好朋友，準備了一系列貼近我們生活的主題。<br/></p><div className="text-center mt-6 py-4"><span className="inline-block bg-[#FFF9C4] px-6 py-3 rounded-full font-black text-xl border-2 border-[#5D4037] shadow-sm transform -rotate-1 text-[#D84315]">✨ 無需準備、不必讀書、帶著好奇心就能參加！ ✨</span></div></div><div className="bg-[#E0F7FA] border-l-8 border-accent-teal p-6 rounded-r-2xl"><h4 className="font-bold text-[#006064] text-xl mb-3 flex items-center gap-2"><Video className="w-6 h-6"></Video> 參加須知
                    </h4><ul className="text-[#006064] space-y-2 font-bold list-disc list-inside text-lg"><li>一律採用 <strong className="text-[#004D40] bg-[#B2EBF2] px-1 rounded">GOOGLE MEET 視訊</strong></li><li>可<strong className="text-[#004D40] bg-[#B2EBF2] px-1 rounded">不開鏡頭</strong>，害羞的朋友也不用擔心喔！</li><li>表單是預先統計人數用的！沒報名也可以當天直接參加！</li></ul></div><div className="mt-2 w-full"><a className="btn-warm py-5 px-6 bg-accent-orange text-[#5D4037] w-full text-2xl md:text-3xl shadow-comic animate-pulse-slow flex flex-col items-center justify-center border-4 border-[#5D4037]" href={TODO_LINKS.LINK_5} target="_blank"><span>📝 立即填寫報名表</span><span className="text-base font-bold mt-2 opacity-80 bg-white/40 px-3 py-1 rounded-full border border-[#5D4037]/20">預先報名讓我們更好準備喔！</span></a></div></div>
...
<a className="btn-warm py-5 px-6 bg-accent-pink text-[#5D4037] w-full text-2xl md:text-3xl shadow-comic animate-pulse-slow flex flex-col items-center justify-center border-4 border-[#5D4037]" href={TODO_LINKS.LINK_6} target="_blank">
<span>📝 前往填寫報名表</span>
...
<div className="mt-2 w-full">
<a className="btn-warm py-5 px-6 bg-accent-blue text-[#5D4037] w-full text-2xl md:text-3xl shadow-comic animate-pulse-slow flex flex-col items-center justify-center border-4 border-[#5D4037]" href={TODO_LINKS.LINK_7} target="_blank">
<span>📝 前往填寫報名表</span>
<span className="text-base font-bold mt-2 opacity-80 bg-white/40 px-3 py-1 rounded-full border border-[#5D4037]/20">報名連結</span>
</a>
</div>
</div>
<div className="border-t-4 border-dashed border-[#5D4037]/20 pt-8"><div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6"><div className="space-y-1"><h3 className="text-2xl font-bold text-[#5D4037] flex items-center gap-2"><span className="bg-accent-teal text-white px-2 py-1 rounded text-lg border border-[#5D4037]">辦理</span>
                            ADHD 成人同儕線上團體-場次說明
                        </h3><p className="text-gray-600 font-medium">(點開有詳細介紹喔！)</p></div></div><div className="session-card"><div className="session-header" ><div className="flex items-center gap-3"><span className="session-tag bg-[#FFCC80] text-[#5D4037]">7月場</span><span className="font-bold text-[#5D4037] text-lg">釋放你的創意靈魂：創作不僅是專業，更是樂趣</span></div><ChevronDown className="w-5 h-5 text-[#5D4037] transition-transform duration-300"></ChevronDown></div><div className="session-content"><div className="p-6 space-y-4"><div className="flex flex-wrap gap-4 text-sm font-bold text-gray-600 bg-white/50 p-3 rounded-lg border border-[#5D4037]/10"><span className="flex items-center gap-1"><Calendar className="w-4 h-4"></Calendar> 7月 18日 (六)</span><span className="flex items-center gap-1"><Clock className="w-4 h-4"></Clock> 14:00 - 16:00</span><span className="flex items-center gap-1"><User className="w-4 h-4"></User> 客座嘉賓：Vtuber 殷緋</span></div><div><h4 className="font-bold text-[#5D4037] mb-2 border-l-4 border-orange-300 pl-2">我們聊什麼：</h4><p className="text-gray-700 leading-relaxed text-justify">
                                ...
                                </a><a className="btn-warm py-2 px-4 bg-[#FFCC80] text-[#5D4037] hover:bg-[#FFB74D] text-sm" href={TODO_LINKS.LINK_8} target="_blank">報名表單</a></div></div></div></div>

<div className="border-t-4 border-dashed border-[#5D4037]/20 pt-8 mt-12 mb-6">
...
<div className="flex flex-wrap gap-4 text-sm font-bold text-gray-600 bg-white/50 p-3 rounded-lg border border-[#5D4037]/10">
...
<div className="relative flex items-center py-8"><div className="flex-grow border-t-2 border-dashed border-[#5D4037]/30"></div><span className="flex-shrink-0 mx-4 text-gray-500 font-bold bg-[#FFFDE7] px-2">籌備中與即將推出</span><div className="flex-grow border-t-2 border-dashed border-[#5D4037]/30"></div></div><div className="construction-card"><div className="construction-badge"><MapPin className="w-3 h-3"></MapPin> 場地確認中
                    </div><div className="flex items-start gap-4"><div className="w-12 h-12 bg-[#FFCCBC] rounded-full flex items-center justify-center border-2 border-[#5D4037] flex-shrink-0"><Users className="w-6 h-6 text-[#5D4037]"></Users></div><div className="flex-grow"><h3 className="text-xl font-bold text-[#5D4037] mb-3">成人ADHD實體活動 <span className="text-sm font-normal text-gray-500">(預計兩場)</span></h3><div className="space-y-4"><div className="bg-white p-3 rounded-lg border border-[#5D4037]/10"><h4 className="font-bold text-[#5D4037] mb-1">🐣 新手大A場</h4><p className="text-gray-600 text-xs leading-relaxed">
                                        你是近年來診斷ADHD的大A嗎？是否有很多疑問或是徬徨，嘿！我們有一群「老」A也走過很多挫折，累積了一些經驗。歡迎來報名大A新手場，讓我們老手帶新手，一起成為A咖！
                                        <br/><span className="text-[#FF9E80] font-bold">欸！資深大A也別走啊，一起來啦~</span></p></div><div className="bg-white p-3 rounded-lg border border-[#5D4037]/10"><h4 className="font-bold text-[#5D4037] mb-1">🎭 大A實驗室-一人一故事劇場演出過動人生</h4><p className="text-gray-600 text-xs leading-relaxed">
                    ...
                    </div><div className="flex items-start gap-4"><div className="w-12 h-12 bg-[#C5E1A5] rounded-full flex items-center justify-center border-2 border-[#5D4037] flex-shrink-0"><BookOpen className="w-6 h-6 text-[#5D4037]"></BookOpen></div><div><h3 className="text-xl font-bold text-[#5D4037] mb-2">家長向-親職教育講座</h3><p className="text-gray-600 text-sm leading-relaxed">
                                預計11月會有一場，地點待訂。
                            </p></div></div></div></div></section></div><div className="bg-[#F0FDF4] border-t border-[#06C755]/20 py-16 mt-20" id="line-contact"><div className="max-w-3xl mx-auto px-4 flex flex-col items-center text-center gap-6"><h4 className="text-3xl font-black text-[#5D4037] mb-2">加入官方 LINE</h4><p className="text-[#5D4037]/80 mb-4 text-lg">取得最新活動資訊、連結以及即時提醒！<br/>不錯過任何一場聚會。</p><a className="btn-warm py-4 px-12 bg-[#06C755] text-white hover:opacity-90 shadow-comic border-transparent text-xl w-full md:w-auto" href="https://line.me/R/ti/p/@823pawtr?oat_content=url&amp;ts=06051740" target="_blank"><MessageCircle className="w-6 h-6 mr-2"></MessageCircle> 立即加入好友
