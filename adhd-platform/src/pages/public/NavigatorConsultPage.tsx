...
<a className="btn-warm py-5 px-6 bg-accent-pink text-brown w-full text-2xl md:text-3xl shadow-warm animate-pulse-slow flex flex-col items-center justify-center border-4 border-brown" href={LINKS.LINK_1} target="_blank">
<span>📝 前往填寫報名表</span>
