...
export default function RecommendationDbContent() {
  return (
    ...
    <p className="text-brown leading-relaxed my-4">在各社群的支持與同意下，我得以發放問卷、彙整資料，並從家長的角度出發，邀請眾多家長分享就診經驗及推薦醫師，最終將這些資訊集結成清冊，並整合至 地圖軟體之中。</p>
    ...
    <h2 className="text-2xl font-bold text-brown mt-8 mb-4">— 彥宇 / 大A哥哥</h2>
    </article>
  );
}
